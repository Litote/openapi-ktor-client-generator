...
public fun String.capitalize(): String =
    if (firstOrNull()?.isLowerCase() == true) replaceFirstChar { it.uppercase() } else this

/**
 * Returns a uncapitalized string.
 */
public fun String.uncapitalize(): String =
    if (firstOrNull()?.isUpperCase() == true) replaceFirstChar { it.lowercase() } else this
 ...
 */
public fun String.tagToCamelCase(): String =
    replace(tagToCamelCaseRegex) { it.value.last().uppercase() }.replace("-", "").capitalize()
