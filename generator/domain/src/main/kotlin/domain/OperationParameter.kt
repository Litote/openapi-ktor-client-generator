 ...
 */
public data class OperationParameter(
    ...
    public val isHeader: Boolean get() = location == ParameterLocation.HEADER
    public val isPath: Boolean get() = location == ParameterLocation.PATH
    public val isQuery: Boolean get() = location == ParameterLocation.QUERY
    public val isEnum: Boolean get() = type is DomainType.InlineType && type.isEnum
